...
our %config = (
  ...
  CPPFLAGS => [ "-DANDROID -I/home/francesco/.buildozer/android/platform/android-ndk-r23b/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include -I/home/francesco/PycharmProjects/py_apk/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/python-installs/Prova/armeabi-v7a/include/python3.9" ],
  CPPINCLUDES => [  ],
  CXX => "/usr/bin/ccache /home/francesco/.buildozer/android/platform/android-ndk-r23b/toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ -target armv7a-linux-androideabi21 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC",
  ...
  perlenv => {
      ...
      "PERL" => undef,
      "RANLIB" => "/home/francesco/.buildozer/android/platform/android-ndk-r23b/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ranlib",
      "RC" => undef,
      "RCFLAGS" => undef,
      "WINDRES" => undef,
      "__CNF_CFLAGS" => undef,
