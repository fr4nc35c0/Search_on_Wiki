...
our %config = (
  ...
  CPPFLAGS => [ "-DANDROID -I/home/francesco/.buildozer/android/platform/android-ndk-r23b/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include -I/home/francesco/PycharmProjects/py_apk/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/python-installs/Prova/arm64-v8a/include/python3.9" ],
  CPPINCLUDES => [  ],
  CXX => "/usr/bin/ccache /home/francesco/.buildozer/android/platform/android-ndk-r23b/toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ -target aarch64-linux-android21 -fomit-frame-pointer -march=armv8-a -fPIC",
